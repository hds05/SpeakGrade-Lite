...
export default function OutletCustomer() {
  ...
  useEffect(() => {
    const completed = localStorage.getItem("OutletCustomer(easy)_Completed") === "true";
    if (completed) {
  ...
  const handleCompletion = () => {
    console.log("✅ Level 6 completed. Saving to localStorage.");
            ...
            >
              ...
              <div className="relative z-20 max-w-2xl w-full px-4">
                <h2 className="text-2xl sm:text-4xl font-bold text-green-400 mb-4">
                  {resolvedCount === 4 ? "🎉 All Issues Resolved!" : "🛒 Shopping Complete!"}
                </h2>
                ...
                <div className="mb-6 p-6 bg-white/10 backdrop-blur-sm rounded-xl border border-white/20">
                  ...
                  <div className="mt-4 p-3 rounded-lg border-2 border-dashed">
                    ...
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      ...
                      <div className={`${issuesResolved.clearance ? "text-green-300" : "text-red-300"}`}>
                        {issuesResolved.clearance ? "✅" : "❌"} T-shirt Price Fix
                      </div>
                      <div className={`${issuesResolved.giftCard ? "text-green-300" : "text-red-300"}`}>
                        {issuesResolved.giftCard ? "✅" : "❌"} Gift Card Applied
                      </div>
                  ...
                  <div className="mt-4 text-center">
                    {(() => {
                      if (resolvedCount === 4) return <div className="text-green-300">🌟 Perfect! Excellent customer service communication!</div>;
                      if (resolvedCount === 3) return <div className="text-green-300">✨ Great job! Most issues handled successfully!</div>;
                      if (resolvedCount === 2) return <div className="text-yellow-300">👍 Good work! Some issues still need attention!</div>;
                      if (resolvedCount === 1) return <div className="text-orange-300">📚 Room for improvement. Be more specific!</div>;
                      return <div className="text-red-300">💪 Keep practicing! Focus on clear explanations!</div>;
                    })()}
                  </div>
                </div>
                ...
                <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-[999]">
                  <div className="bg-white rounded-xl shadow-lg max-w-2xl w-full p-6 text-center max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="text-left mb-6">
                      ...
                      <h3 className="font-semibold text-gray-800 mb-2">🛍️ Your Shopping Situation:</h3>
